...
public class DeleteEquipmentAppl implements Initializable {
    ...
    public  void buttonGetDeleteData(ActionEvent event) throws IOException{
        ...
        readData.readEquip(equipList);
        ObservableList<Equipment> equipment= readData.readKnightsEquipmentforDelete(readData.userid(loginlist, AllDataInterface.getUser()),allDataInterface.getIdofKnight(),knightInfo,equipList);
        EquipTable.setItems(equipment);
        ObservableList<Weapon> weapons= readData.readKnightsWeaponforDelete(readData.userid(loginlist, AllDataInterface.getUser()),allDataInterface.getIdofKnight(),knightInfo,weaponList1);
